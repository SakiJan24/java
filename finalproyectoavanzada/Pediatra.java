...
public class Pediatra extends Med {
    private String tipo = "PEDIATRA";
    private int start = 8;
    private int end = 17;
  ...
  //  LinkedList <Fecha> calendario; Esto va pa Med
    ...
    Pediatra(String nombre, int id, int valorHora) {
      ...
      try {
        ...
        //   System.out.println(c);
            ...
            //System.out.println("Holaaaaa");
              Cita laCita = new Cita();
            laCita.setCita(String.valueOf(((this.start+j)/2)+4), true);
...
*/
  ...
  Entrada: Ninguna
  Salida: Ninguna
  Objetivo: crea un archivo con el id del pediatra, este escribira los dias y las horas que tiene dicho medico disponible
*/
  ...
  Entrada: int dia, double hora
  Salida: ninguna
  Objetivo:ingresar el dia y la hora en la que el paciente busca agendar su cita, si estas estan disponibles llama a escribir disponibilidad para reescribir el archivo, cambiando el valor dell bool de la hora y fecha escogida por false, para que asi figure como que esa cita ya esta ocupada
*/
